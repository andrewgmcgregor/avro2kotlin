...
data class SkinnyAvroInterfaceSpec(val namespace: String,
                                   val name: String,
...
object SkinnySchemaSpecBuilder {
    fun generateFromAvdl(inputStream: InputStream): SkinnyAvroInterfaceSpec {
        ...
        return SkinnyAvroInterfaceSpec(
